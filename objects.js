...
var email = {
  sender: 'raplh@dutchbros.com',
  recipient: 'karen.nunquist@bunker.org',
  subject: 'Coffee',
...
// Then, print the email Array to the Terminal.
 var emails = [
    {
      sender: 'silly@dipshit.com',
      recipient: 'bigdummy@ohwell.net',
      subject: 'You are a big dummy',
      body: 'You are a big dummy for sure',
      signature: 'Silly'
    },
    {
      sender: 'givesmelife@wellfound.org',
      recipient: 'nervouscritter@gmail.com',
      subject: 'I love you',
      body: 'I love you so much',
      signature: 'Givesmelife'
    },
    {
      sender: 'hellorockview@aol.com',
      recipient: 'berniesanders@state.gov',
      subject: 'Hello',
      body: 'Hello Bernie',
      signature: 'Rockview'
    }
